                        ...
                        dbc.CardBody(
                            [
                                ...
                                [
                                    ...
                                    dbc.Col(
                                        dbc.Card(["Increase sales by add ", html.H5(html.Div(id='increase_sales_adder_str'))]),
                                ...
                                [
                                    dbc.Col(
                                        dbc.Card(["Decrease sales by add ", html.H5(html.Div(id='decrease_sales_adder_str'))]),
