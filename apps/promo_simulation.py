                        ...
                        dbc.CardBody(
                            [
                                ...
                                [
                                    ...
                                    dbc.Col(
                                        dbc.Card("Increase sales by add {}".format(html.Div(id='increase_sales_adder_str')), body=True),
                                ...
                                [
                                    dbc.Col(
                                        dbc.Card("Decrease sales by add {}".format(html.Div(id='decrease_sales_adder_str')), body=True),
