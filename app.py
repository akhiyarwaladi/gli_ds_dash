...
sidebar = dac.Sidebar(
	dac.SidebarMenu(
		[
			...
			dac.SidebarHeader(children="alfagift insight", style={'font-size':'16px'}),
            ...
            dac.SidebarHeader(children="user behavior", style={'font-size':'16px'}),
            dac.SidebarMenuItem(label='Moengage', icon='cubes', children=sub_event),
            dac.SidebarHeader(children="member DNA", style={'font-size':'16px'}),
